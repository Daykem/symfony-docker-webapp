...
class __TwigTemplate_2a7d131ed9eb1036682688f2de4fd3dafa5208ad323825bd8ef03940f258fec3 extends Template
{
    private $source;
    private $macros = [];
...
{% macro form_tree_details(name, data, forms_by_hash, show) %}
    ...
    {% endfor %}
{% endmacro %}
", "@WebProfiler/Collector/form.html.twig", "/Users/tomrouvier/Tom/Test eukles/tmp/demo-test/vendor/symfony/web-profiler-bundle/Resources/views/Collector/form.html.twig");
    }
}
